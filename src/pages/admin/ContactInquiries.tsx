                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-4 border-t">
                    <button
                      ...
                      className="w-full px-4 py-3 bg-gradient-to-br from-red-100 to-red-200 text-red-800 rounded-xl text-sm font-medium hover:from-red-200 hover:to-red-300 transition-all duration-300 border border-red-300"
                    >
                      Delete Inquiry
                    </button>
                  </div>
