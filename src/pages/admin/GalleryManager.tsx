    ...
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-2">
          <button
            onClick={simpleTest}
            className="btn-secondary px-4 py-2 flex items-center gap-2 bg-yellow-500 text-white hover:bg-yellow-600 border-yellow-500"
          >
            Simple Test
          </button>
          <button
            onClick={runDebugTests}
            className="btn-secondary px-4 py-2 flex items-center gap-2 bg-red-500 text-white hover:bg-red-600 border-red-500"
          >
            ...
            {items.map((item) => (
              <div key={item.id} className="group relative modern-card overflow-hidden hover-lift">
                ...
                <div className="p-4">
                  ...
                  {item.category && (
                    <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-br from-cyan-100 to-cyan-200 text-cyan-800 border border-cyan-300 mb-3">
                      {item.category}
                    </span>
                  )}
